...
const runResultGrid = { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 12 };
const runResultCard = { borderRadius: 14, border: "1px solid #e5e7eb", background: "#f8fafc", padding: 14, display: "grid", gap: 8 };
const runCardHeader = { display: "flex", justifyContent: "space-between", gap: 16, alignItems: "center", flexWrap: "wrap", marginBottom: 14 };
const runFilterBlock = { display: "grid", gap: 8, minWidth: "min(100%, 320px)" };
const runFilterInput = { borderRadius: 14, border: "1px solid #cbd5e1", padding: "12px 14px", font: "inherit", minWidth: 0 };
...
const toggleButton = { border: "1px solid #fdba74", borderRadius: 12, background: "#fff7ed", color: "#9a3412", padding: "10px 14px", fontWeight: 700, cursor: "pointer" };
